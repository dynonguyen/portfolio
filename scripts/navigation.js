...
function renderNavigation() {
	...
	mobileXml += `<li class="nav-link" ${LINK_KEY}=""><a href="/assets/CV_NguyenLeAnhTuan.pdf" target="_blank"><i class="fas fa-file-pdf"></i></a></li>`;
	desktopXml += `<li class="nav-link" ${LINK_KEY}=""><a href="/assets/CV_NguyenLeAnhTuan.pdf" target="_blank">My CV</a></li>`;
